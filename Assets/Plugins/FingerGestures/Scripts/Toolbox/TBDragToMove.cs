...
public class TBDragToMove : MonoBehaviour
{
	...
	private FingerGestures.Finger draggingFinger = null;
	private GestureRecognizer gestureRecognizer;

	private bool oldUseGravity = false;
	private bool oldIsKinematic = false;

	private Vector3 physxDragMove = Vector3.zero;   // used for rigidbody drag only. This stores the drag amount to apply during the physics update in FixedUpdate()
