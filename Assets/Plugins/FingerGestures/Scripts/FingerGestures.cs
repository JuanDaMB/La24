...
public class FingerGestures : MonoBehaviour
{
	...
	public class Finger
	{
		...
		private int index = 0;
		private FingerPhase phase = FingerPhase.None;
		private FingerPhase prevPhase = FingerPhase.None;
		...
		private float distFromStart = 0;
		private bool moved = false;
		private bool filteredOut = true; // is this finger being filtered out?
		private Collider collider;
		private Collider prevCollider;
		private float elapsedTimeStationary = 0;
	...
	#endregion Standard Global & Per-Finger Gesture Recognizers
	...
	#endregion Finger List Data Structure
	...
	private static readonly SwipeDirection[] AngleToDirectionMap = new SwipeDirection[]
	{
...
iPad mini2    2048x1536 326 ppi
	...
	private const float DESKTOP_SCREEN_STANDARD_DPI = 96; // default win7 dpi
	private const float INCHES_TO_CENTIMETERS = 2.54f; // 1 inch = 2.54 cm
	private const float CENTIMETERS_TO_INCHES = 1.0f / INCHES_TO_CENTIMETERS; // 1 cm = 0.3937... inches
