...
public class PointCloudRegognizer : DiscreteGestureRecognizer<PointCloudGesture>
{
	...
	#endregion Runtime Gesture Processing
	...
	private PointCloudGesture debugLastGesture = null;
	private NormalizedTemplate debugLastMatchedTemplate = null;
