...
public class PointCloudGestureEditor : EditorWindow
{
	...
	private PointCloudGestureTemplate template;
	...
	private void Init(PointCloudGestureTemplate template)
	{
	...
	private void OnMouseDrag(Vector2 pos)
	{
		if (recording)
		{
			if (points.Count > 0)
