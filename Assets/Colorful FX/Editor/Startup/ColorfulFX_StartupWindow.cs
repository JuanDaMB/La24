...
public sealed class ColorfulFX_StartupWindow : EditorWindow
{
	...
	private static string pathChangelog = "Assets/Colorful FX/Changelog.txt";
	private static string pathImages = "Assets/Colorful FX/Editor/Startup/Images/";

	private Texture2D headerPic;
	...
	private Texture2D iconColorful;
	private Texture2D iconSSAOPro;
	private Texture2D iconLutify;
	...
	private void HR(int prevSpace, int nextSpace)
	{
