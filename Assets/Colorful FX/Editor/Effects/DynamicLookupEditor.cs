...
namespace Colorful.Editors
{
	...
	public class DynamicLookupEditor : BaseEffectEditor
	{
		...
		private SerializedProperty p_White;
		private SerializedProperty p_Black;
		private SerializedProperty p_Red;
		private SerializedProperty p_Green;
		private SerializedProperty p_Blue;
		private SerializedProperty p_Yellow;
		private SerializedProperty p_Magenta;
		private SerializedProperty p_Cyan;

		private static Material m_GraphMaterial;
		private static Texture2D m_CursorActive;
		private static Texture2D m_CursorInactive;

		private SerializedProperty[] m_Colors;
		private SerializedProperty m_SelectedColor;
		private Rect[] m_ClickRectsWhite;
		private Rect[] m_ClickRectsBlack;
		private float m_InspectorWidth = 1f;
		...
		private void DrawIsometricCube(Rect r, SerializedProperty centerColor, bool seeThrough)
		{
			CheckResources();
		...
		private void ComputeInspectorWidth()
		{
