...
namespace Colorful.Editors
{
	...
	{
		private SerializedProperty p_AutomaticPhase;
		private SerializedProperty p_Phase;
		private SerializedProperty p_ConvertToGrayscale;
		private SerializedProperty p_NoiseIntensity;
		private SerializedProperty p_ScanlinesIntensity;
		private SerializedProperty p_ScanlinesCount;
		private SerializedProperty p_ScanlinesOffset;
		private SerializedProperty p_VerticalScanlines;
		private SerializedProperty p_Distortion;
		private SerializedProperty p_CubicDistortion;
