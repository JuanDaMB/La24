...
namespace Colorful.Editors
{
	...
	{
		private SerializedProperty p_RedSteepness;
		private SerializedProperty p_RedGamma;
		private SerializedProperty p_GreenSteepness;
		private SerializedProperty p_GreenGamma;
		private SerializedProperty p_BlueSteepness;
		private SerializedProperty p_BlueGamma;
		private SerializedProperty p_ShowCurves;
		...
		private float curve(float o, float steepness, float gamma)
		{
