...
namespace Colorful.Editors
{
	...
	{
		private SerializedProperty p_Divisor;
		private SerializedProperty p_KernelTop;
		private SerializedProperty p_KernelMiddle;
		private SerializedProperty p_KernelBottom;
		...
		private static Vector3[,] presetsData = { { new Vector3(0f, 0f, 0f), new Vector3(0f, 1f, 0f), new Vector3(0f, 0f, 0f) },
		...
		private static float[] presetsDiv = { 1f, 1f, 1f, 16f, 1f, 1f, 1f };
