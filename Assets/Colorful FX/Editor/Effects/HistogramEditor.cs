...
namespace Colorful.Editors
{
	...
	public class HistogramEditor : BaseEffectEditor
	{
		...
		private Histogram m_Target;
		private int[] m_Histogram = new int[256];
		private int[] m_HistogramRGB = new int[256 * 3];
		private Rect m_HistogramRect = new Rect(0f, 0f, 1f, 1f);
		private Texture2D m_TempTexture;

		private Color MasterColor = new Color(1f, 1f, 1f, 2f);
		private Color RedColor = new Color(1f, 0f, 0f, 2f);
		private Color GreenColor = new Color(0f, 1f, 0f, 2f);
		private Color BlueColor = new Color(0f, 1f, 1f, 2f);
		...
		private void DrawHistogramRGB(Rect rect)
		{
			// Scale histogram values
