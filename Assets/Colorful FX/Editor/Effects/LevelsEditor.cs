...
namespace Colorful.Editors
{
	...
	public class LevelsEditor : BaseEffectEditor
	{
		...
		private SerializedProperty p_InputL;
		private SerializedProperty p_InputR;
		private SerializedProperty p_InputG;
		private SerializedProperty p_InputB;
		private SerializedProperty p_OutputL;
		private SerializedProperty p_OutputR;
		private SerializedProperty p_OutputG;
		private SerializedProperty p_OutputB;

		private SerializedProperty p_CurrentChannel;
		private SerializedProperty p_Logarithmic;
		private SerializedProperty p_AutoRefresh;

		private Levels m_Target;
		private Texture2D m_TempTexture;
		private int[] m_Histogram = new int[256];
		private Rect m_HistogramRect = new Rect(0f, 0f, 1f, 1f);

		private Color MasterColor = EditorGUIUtility.isProSkin ? new Color(1f, 1f, 1f, 2f) : new Color(0.1f, 0.1f, 0.1f, 2f);
		private Color RedColor = new Color(1f, 0f, 0f, 2f);
		private Color GreenColor = EditorGUIUtility.isProSkin ? new Color(0f, 1f, 0f, 2f) : new Color(0.2f, 0.8f, 0.2f, 2f);
		private Color BlueColor = EditorGUIUtility.isProSkin ? new Color(0f, 1f, 1f, 2f) : new Color(0f, 0f, 1f, 2f);
		...
		private static float[,] presetsData = { { 0, 1, 255, 0, 255 }, { 15, 1, 255, 0, 255 }, { 10, 1, 245, 0, 255 },
		...
		private void ChannelUI(float width, SerializedProperty input, SerializedProperty output)
		{
		...
		private void UpdateHistogram(RenderTexture source)
		{
